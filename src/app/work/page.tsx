...
const Page = () => {
  return (
    <div className="mt-4">
      ...
      <p className="text-gray-600 dark:text-gray-300 [font-size:_clamp(1.2rem,1.5vw,2rem)]">
        ...
        {skills.map((item, ind) => {
          return (
            <motion.span
              ...
              viewport={{once: true}}
              key={ind}
              className={`md:text-xl dark:bg-black border dark:border-[#444] border-[#999] dark:hover:border-blue-200 dark:hover:text-blue-200 hover:border-blue-400 hover:text-blue-600 p-2 rounded-lg text-gray-600 dark:text-gray-300 hover:skew-y-3 ease-in-out duration-500 hover:scale-110`}
            >
              {item}
            </motion.span>
          );
